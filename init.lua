...
-- Fix clipboard issue - Enable if found again
-- vim.opt.mouse = ""
vim.o.mouse = "a"
...
-- Set configuration related to tab expansion into spaces
vim.o.expandtab = true

-- Mark max column size
...
-- Make sure leader key has no conflict
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					-- Show documentation
					map("<leader>k", vim.lsp.buf.hover, "Do[k]umentation")
			...
			local servers = {
				...
				pylsp = {
					-- Use UV to run pylsp - automatically handles virtual environment
					cmd = { "uv", "run", "pylsp" },

					-- Root directory detection (UV projects)
					...
					settings = {
						pylsp = {
							plugins = {
								-- Enable/disable various plugins as needed
								pycodestyle = {
									enabled = true,
									ignore = { "W391", "E501" }, -- Blank line at end of file and maximum line size
									maxLineLength = 120,
								},
								pyflakes = { enabled = true },
								pylint = { enabled = false }, -- Can be slow
								autopep8 = { enabled = false }, -- Use if you want auto-formatting
								yapf = { enabled = false },
								black = { enabled = false }, -- Use if you prefer black formatting
							},
						},
					},
				},
	...
	{ -- Autocompletion
		...
		opts = {
			keymap = {
				...
				-- Tab/S-Tab freed for minuet virtual text; use C-y/C-b for snippets
				["<Tab>"]   = {},
				["<S-Tab>"] = {},
